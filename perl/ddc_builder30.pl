...
my $mongodb_latest =
  'http://fastdl.mongodb.org/linux/mongodb-linux-x86_64-ubuntu1204-3.0.2.tgz';
...
print << "GREETINGS";
   ...
   You need to be running this script as root.  If not already doing so,
...
DOCKER:
Docker may be needed, and may be added to this script in the future
...
As a non-root user, consider adding $user to the "docker" group:
...
print my $index_html << "INDEX"

<html><body><h1>Welcome to CADBox</h1>

...
system("mkdir -m 755 /home/$user/dbdotcad/{cad,ddclog}");
...
# So that logs from the users directory & cad files can be viewed from a web page, 
# a direcotry is added into the document root and an Alias will be used making it look like /home/$user
# when using brace expansion dont use spaces, separate with comma only
system("mkdir -m 755 /var/www/{ddclog,cad}");
...
<p><a href="/home/$user/dbdotcad/ddclog">users log</a></p>
<p><a href="/home/$user/dbdotcad/cad">users log</a></p>

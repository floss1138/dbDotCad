...
my $ddc_read = 'ddc_read05.pl';
# Specify the path to reach the above file on Github:
my $git_path = 'https://raw.githubusercontent.com/floss1138/dbDotCad/master/perl/'
...
<p>To create a shortcut, hover over the folder icon in the Explorer window address bar and drag to Desktop or Favourites to create a short cut</p>

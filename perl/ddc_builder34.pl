...
print << "GREETINGS";
   ...
   It is about to install onto this host with IP address: $ipaddress
...
# So that logs from the users directory can be viewed from a web page, an Alias will be used in Apache 
system ("mkdir -m 755 /var/www/apache/ddclog");
system ("mkdir -m 755 /home/$user/ddclog");
...
<p>To access SAMBA share from Windows, use:  \\\\$ipaddress\\$user </p>
<p>In Windows Explore <br> or <br> Start, then, Search programs and files <br>
paste in the above link. <br>
The 'Enter Network Password' box should open <br>
After validation, the Explore Window should show the users home directory</p>
</body></html>

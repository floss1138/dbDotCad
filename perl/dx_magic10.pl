...
our $VERSION = '0.0.10';     # version of this script
...
#TODO set state to TAG after (DS) 1 OR ACDbAttribute (DS1), set state to ATTRIBUTE after AcDBAttribute, 
# set state to something higher (try BLOCKNAME) for AcDblockBegin, AcDbBlockTableRecord, AcDbDimStyleTableRecord
...
## FUDGING STATE HERE:
                $state = 'ATTRIBUTE';
# BECASUE in AUTO AcDbAttribute comes before the 1 - which is more logical anyway

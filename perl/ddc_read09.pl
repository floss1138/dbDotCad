...
our $VERSION = '0.0.09';    # Version number of this script
...
# e.g for numeric part of string '1-123-45-6789-MAD_just a test_file.txt'
# fname_match1="^[0-9]+-[0-9]+-[0-9]+-[A-Z]+_.*" (N-N-N-A_anYthinG)
# fname_match2="^[0-9]+-([0-9]+-){3}[A-Z]+_.*" (N-N-N-N-A_anYthingG)
fname_match1="^[0-9]+-[0-9]+-[0-9]+-[A-Z]+_.*"
fname_match2="^[0-9]+-([0-9]+-){3}[A-Z]+_.*"
...
TAG
    ...
    print " ddc.conf created.  Run again without -c switch\n\n";
    exit 0;

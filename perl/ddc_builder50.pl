...
my $mongodb_latest =
  'https://fastdl.mongodb.org/linux/mongodb-linux-x86_64-ubuntu1404-3.2.0.tgz';

my $dream_bitnami = 
#  'https://bitnami.com/redirect/to/109810/bitnami-dreamfactory-2.2.0-0-linux-x64-installer.run'; 
  'https://bitnami.com/redirect/to/124564/bitnami-dreamfactory-2.3.0-2-linux-x64-installer.run';
...
print << "GREETINGS";
   ...
   14.04 32 bit desktop, 64 bit server & 15.04 64 bit server.
